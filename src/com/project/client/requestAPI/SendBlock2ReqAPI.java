...
@WebServlet(name = "SendBlock2ReqAPI")
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            ...
            if(ConstantClass.SERVER1_STATUS) {
                System.out.println("trying server1 block2:"+ConstantClass.SERVER1_TRY);
                url = new URL(ConstantClass.SEND_BLOCK2_URL1);
            }
            else {
                System.out.println("trying server2 block2: "+ConstantClass.SERVER2_TRY);
                url = new URL(ConstantClass.SEND_BLOCK2_URL2);
            }
