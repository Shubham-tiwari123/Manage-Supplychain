...
public class SendBlockReqAPI extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            ...
            String blockString = transferBlock.prepareBlock(blockID,quantity,productName,supplierName,price,date);
            ...
            if(ConstantClass.SERVER1_STATUS) {
                System.out.println("trying server1 block1:"+ConstantClass.SERVER1_TRY);
                url = new URL(ConstantClass.SEND_BLOCK1_URL1);
            }
            else {
                System.out.println("trying server2 block1: "+ConstantClass.SERVER2_TRY);
                url = new URL(ConstantClass.SEND_BLOCK1_URL2);
            }
