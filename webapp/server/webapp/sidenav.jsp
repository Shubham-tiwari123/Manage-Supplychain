...
<div id="block-area" style="margin-top: 50px; height: fit-content;
             width: fit-content">
    <img src="static/images/database.png " style="width: 35px;height: 35px; float: left; margin-left: 17px;
                margin-top: 27px">
    <p style="float: right; margin-right: 65px;font: bold 19px Arial, Helvetica, sans-serif;
            color: #20509E;"><a href="/database" style="color: inherit; text-decoration: none">Database</a>
</div>
